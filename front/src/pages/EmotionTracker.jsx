...
const EmotionTracker = () => {
    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        try {
          ...
          const file = new File([wavBlob], "live_recording.wav", {
            type: "audio/wav",
          });
          setVoiceFile(file);
        } catch (err) {
          ...
          const file = new File([fallbackBlob], "live_recording.webm", {
            type: "audio/webm",
          });
          setVoiceFile(file);
        }
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      setAdvice(
        unifiedData.advice || "No specific advice generated for this session.",
      );

      // ── Persist detected emotion + generate game recommendation ──
      const rawEmotion = (
        unifiedData?.emotion?.state || "neutral"
      ).toLowerCase();
      ...
      const spec = generateGame({
        ...
        streak_days,
        past_sessions: past_sessions.map((s) => ({
          game_type: s.game_type || s.game_name,
    ...
    <div className="animate-fade-in flex-col gap-6" style={{ display: "flex" }}>
      <div>
        ...
        <p className="text-muted mt-2">
          Capture a live photo, record your voice, or upload media to analyze
      ...
      >
        ...
        >
          <div className="flex justify-between items-center">
            ...
            >
              <Camera color="var(--accent-primary)" /> Facial Scan
            </h3>
            {faceFile && (
              <span
        ...
        >
          <div className="flex justify-between items-center">
            ...
            >
              <Mic color="var(--accent-secondary)" /> Voice Scan
            </h3>
            {voiceFile && (
              <span
                className="flex items-center gap-1"
      ...
      {result && (
        <div
          className="animate-fade-in flex-col gap-6"
        ...
        >
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  {result?.emotion?.confidence && (
                    ...
                    >
                      {(result.emotion.confidence * 100).toFixed(1)}% Artificial
                      Match
                    </span>
                  )}
                </div>
          ...
          {contactNotified === "success" && (
            ...
            >
              ...
              <div>
                ...
                >
                  A professional automated email has just been dispatched to
                  your trusted contact because a high stress emotion was
                  cataloged.
                </span>
              </div>
            </div>
          ...
          {contactNotified === "failed" && (
            ...
            >
              ...
              <div>
                ...
                >
                  Safety Alert Could Not Be Sent
                </strong>
                <span
                  className="text-sm"
                  style={{ color: "var(--text-secondary)" }}
                >
                  We attempted to auto-notify your trusted contact about your
                  high-stress state, but no configured/accepted contact was
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Based on your detected emotional state
                  </p>
                </div>
                <div
                  style={{
                ...
                >
                  <span style={{ fontSize: "1.5rem" }}>
                    {EMOTION_EMOJIS[result?.emotion?.state?.toLowerCase()] ||
                      "🎮"}
                  </span>
                  <span
                    style={{
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        fontSize: "0.72rem",
                        fontWeight: 700,
                        color: DIFFICULTY_COLORS[gameRec.difficulty],
                        background: `${DIFFICULTY_COLORS[gameRec.difficulty]}22`,
                        border: `1px solid ${DIFFICULTY_COLORS[gameRec.difficulty]}44`,
                      }}
                    >
                      {gameRec.difficulty}
                    </span>
              ...
              >
                ...
                >
                  This game was selected specifically for your{" "}
                  <strong style={{ color: "#c4b5fd" }}>
                    {result?.emotion?.state || "current"}
                  </strong>{" "}
                  mood. Playing for just {gameRec.estimated_time} can
                  meaningfully shift your emotional state.
                </span>
              </div>
            </div>
          )}
          ...
          {result &&
            ["sad", "angry"].includes(result?.emotion?.state?.toLowerCase()) &&
            user?.following?.length > 0 && (
              ...
              >
                <div>
                  ...
                  >
                    You are tracking intense emotions. A session with a
                    professional you follow might be helpful right now.
                  </p>
                </div>
                <button
