      ...
      >
        <div className="alert-banner declining">
          ...
          <div className="alert-content">
            ...
            <p>{error}</p>
            <button className="btn btn-secondary mt-3" onClick={handleRefresh}>
              Try Again
            </button>
          </div>
        </div>
      ...
      <div className="analytics-header">
        <div>
          ...
          <p className="text-muted mt-2">
            AI-powered insights based on your emotional trends and tracking
            history.
          </p>
        </div>
        <div
        ...
        >
          <button
            ...
            style={{
              padding: "0.5rem 1rem",
              background:
                timeRange === "week" ? "var(--accent-primary)" : "transparent",
              border: "none",
          ...
          <button
            ...
            style={{
              padding: "0.5rem 1rem",
              background:
                timeRange === "month" ? "var(--accent-primary)" : "transparent",
              border: "none",
              color: timeRange === "month" ? "#fff" : "var(--text-secondary)",
            }}
      ...
      {analysis.trend === "declining" && (
        <div className="alert-banner declining">
          ...
          <div className="alert-content">
            ...
            <p>
              We've noticed a downward trend in your emotional state recently.
              It's perfectly okay to have down days. Consider taking a break or
              trying a breathing exercise in the Games section.
            </p>
          </div>
        </div>
      )}
      ...
      {analysis.trend === "improving" && (
        <div className="alert-banner improving">
          ...
          <div className="alert-content">
            ...
            <p>
              Your emotional state has been steadily improving. Keep up your
              current routines and self-care habits—they are working!
            </p>
          </div>
        </div>
      )}
      ...
      <div className="kpi-grid">
        <div className="kpi-card">
          ...
          <div className="text-muted text-sm">
            Most frequent state this {timeRange}
          </div>
        </div>
            ...
            <ResponsiveContainer width="100%" height="100%" minWidth={0}>
              ...
              >
                <defs>
                  <linearGradient id="colorValence" x1="0" y1="0" x2="0" y2="1">
                    <stop
                      offset="5%"
                      stopColor={
                        analysis.trend === "declining" ? "#ef4444" : "#10b981"
                      }
                      stopOpacity={0.3}
                    />
                    <stop
                ...
                <RechartsTooltip
                  ...
                  formatter={(value) => [value, "Valence Score"]}
                />
                <Area
                  type="monotone"
                  dataKey="avg_valence"
            ...
            {analysis.critical_days && analysis.critical_days.length > 0 ? (
              ...
              >
                <p style={{ color: "#10b981", margin: 0 }}>
                  No critical mood drops detected in this period. Great job!
                </p>
              </div>
            )}
          </div>
